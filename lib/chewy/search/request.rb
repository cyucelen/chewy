  ...
  module Search
    ...
    class Request
      ...
      DELEGATED_METHODS = %i[
        ...
        scroll_results scroll_wrappers ignore_unavailable function_score score_mode boost_mode
      ].to_set.freeze
      ...
      WHERE_STORAGES = %i[
        query filter post_filter none min_score rescore indices_boost collapse function_score
      ].freeze
      ...
      #   @param value [Hash]
      #   @return [Chewy::Search::Request]
      %i[request_cache search_type preference timeout limit offset terminate_after min_score ignore_unavailable collapse score_mode boost_mode].each do |name|
